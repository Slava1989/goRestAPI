...
type CommentService interface {
	...
	GetComment(context context.Context, ID string) (comment.Comment, error)
	UpdateComment(context context.Context, ID string, newCmt comment.Comment) (comment.Comment, error)
	DeleteComment(context context.Context, ID string) error
}
